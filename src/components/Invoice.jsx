...
function Invoice () {
  ...
  <div className="text-center">
    <button type="button" className="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none" data-hs-overlay="#hs-ai-modal">
      Open modal
    </button>
  </div>
  {/* Modal */}
  <div id="hs-ai-modal" className="hs-overlay  size-full fixed top-0 start-0 z-[80]  overflow-y-auto pointer-events-none">
        ...
        <div className="p-4 sm:p-7 overflow-y-auto">
          ...
          <div className="mt-5 sm:mt-10 grid grid-cols-2 sm:grid-cols-3 gap-5">
            <div>
              ...
              <span className="block text-sm font-medium text-gray-800 dark:text-neutral-200">$316.8</span>
            </div>
            {/* End Col */}
            <div>
