  ...
  return (
    <>
      ...
      <motion.div
        ...
        animate={{ opacity: 2 }}
        exit={{ opacity: 0 }}
        className='bg-white dark:bg-zinc-800 border rounded-xl dark:text-white  shadow-md p-8'
      >
<form className="w-full max-w-lg">
  <div className="flex flex-wrap -mx-3 mb-6">
    ...
    <div className="w-full md:w-1/3 px-3 mb-6 md:mb-0">
      ...
      <button id="states-button" onClick={() =>  {!moned ? setMoned(true) : setMoned(false)}} data-dropdown-toggle="dropdown-states" className="flex py-3 px-8 text-sm font-medium text-center text-gray-500 bg-gray-100 border border-gray-300 rounded hover:bg-gray-200 focus:ring-4 focus:outline-none focus:ring-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:focus:ring-gray-700 dark:text-white dark:border-gray-600" type="button">
          ...
          DOP <svg className="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4"/>
    </svg>
      </button>
      <div id="dropdown-states" className={`z-10  bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 ${moned ? 'show' : 'hidden'} absolute`}>
